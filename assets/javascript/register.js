...
const REGISTER_URL =
  "https://learn-application.herokuapp.com/api/account/register";
...
const registerSuccededMessage = document.querySelector(
  ".register-successful-wrapper"
);
const incorrectPasswordMessage = document.querySelector(
