...
async function getRememberedCards() {
  ...
  data.forEach((element) => {
    ...
    rememberedWordElement.innerHTML = `<div class="translation">
...
function wordSectionEvents() {
  ...
  deleteButton.forEach((element) => {
    element.addEventListener("click", function (event) {
      request.sendRequestAsyncWithRefresh(
        "DELETE",
        `https://learn-application.herokuapp.com/api/card/${this.dataset.id}`
      );
